...
<div class="hd-tab__nav <?php echo esc_attr( $args['class'] ) ?>" data-visibility="hidden">
    <div class="hd-tab__nav__container">
        <button class="hd-tab__nav__action-btn hd-btn-icon hd-btn-icon--square" data-event="prev" data-state="disabled" aria-label="<?php echo __( 'Previous', 'handy-variation-swatches' ); ?>">
        ...
        <button class="hd-tab__nav__action-btn hd-btn-icon hd-btn-icon--square" data-event="next" data-state="default" aria-label="<?php echo __( 'Next', 'handy-variation-swatches' ); ?>">
