        ...
        <div class="hd-home__container">
            <div class="hd-home__banner">
                <div class="hd-txt-center">
                    ...
                    <p class="hd-fs-16">
                        <?php echo __( 'Build an amazing WordPress website faster with our handy tools.', 'handy-variation-swatches' ); ?>
                    </p>
                </div>
            </div>
                    ...
                    <div class="hd-home__plugin">
                        ...
                        <div class="hd-home__plugin__footer">
                            <div class="hd-home__plugin__control">
                                <div class="hd-col-left">
                                    <p class="hd-fw-600">
                                        <?php echo __( 'Status: ', 'handy-variation-swatches' ); ?>
                                        <span class="hd-clr-black-4">
                                            <?php
                                                if ( Plugins::is_installed( $plugin['slug'] ) ) {
												echo __( 'Installed', 'handy-variation-swatches' );
                                                } else {
												echo __( 'Not Installed', 'handy-variation-swatches' );
                                                }
                                            ?>
                                        </span>
                                    </p>
