...
!function() {
/*!****************************************************!*\
  !*** ./resources/admin/scripts/hvsfw-attribute.js ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_settingField_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/settingField.js */ "./resources/admin/scripts/modules/settingField.js");
/**
 * Internal Modules.
 */
...
hvsfw.form = {
   ...
   * @since 1.0.0
   */
  poseTypeSelectorField: function poseTypeSelectorField() {
    var formFieldStyleElem = document.getElementById('hvsfw-form-field-style');
    var attributeTypeElem = document.getElementById('attribute_type');
    if (formFieldStyleElem && attributeTypeElem) {
      attributeTypeElem.setAttribute('data-prefix', 'hvsfw');
      var formFieldTypeElem = attributeTypeElem.closest('.form-field');
  ...
  settingFieldEvents: function settingFieldEvents() {
    _modules_settingField_js__WEBPACK_IMPORTED_MODULE_0__["default"].init({
      page: 'attribute',
      type: '#attribute_type',
      style: '#hvsfw_style',
      shape: '#hvsfw_shape'
...
/******/ })()
;
//# sourceMappingURL=hvsfw-attribute.js.map